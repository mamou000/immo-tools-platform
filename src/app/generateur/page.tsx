...
export default function GenerateurPage() {
  ...
  React.useEffect(() => {
    const isComplete = formData.nomVendeur !== '' 
      && formData.adresseBien !== '' 
      && formData.prixPropose !== '';
    
    setShowPreview(isComplete);
  }, [formData]);
...
${formData.conditionsSuspensives.includes('pret') ? `Cette offre est soumise aux conditions suspensives suivantes :
